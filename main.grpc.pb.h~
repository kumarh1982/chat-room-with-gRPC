 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status ListRoom(::grpc::ClientContext* context, const ::hw::Request& request, ::hw::ChatRoom* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::hw::ChatRoom>> AsyncListRoom(::grpc::ClientContext* context, const ::hw::Request& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::hw::ChatRoom>>(AsyncListRoomRaw(context, request, cq));
    }
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::hw::ChatRoom>* AsyncListRoomRaw(::grpc::ClientContext* context, const ::hw::Request& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status ListRoom(::grpc::ClientContext* context, const ::hw::Request& request, ::hw::ChatRoom* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::hw::ChatRoom>> AsyncListRoom(::grpc::ClientContext* context, const ::hw::Request& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::hw::ChatRoom>>(AsyncListRoomRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::hw::ChatRoom>* AsyncListRoomRaw(::grpc::ClientContext* context, const ::hw::Request& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status ListRoom(::grpc::ServerContext* context, const ::hw::Request* request, ::hw::ChatRoom* response);
  ...
  class WithAsyncMethod_ListRoom : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status ListRoom(::grpc::ServerContext* context, const ::hw::Request* request, ::hw::ChatRoom* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestListRoom(::grpc::ServerContext* context, ::hw::Request* request, ::grpc::ServerAsyncResponseWriter< ::hw::ChatRoom>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_ListRoom<WithAsyncMethod_JoinRoom<WithAsyncMethod_LeaveRoom<WithAsyncMethod_Chat<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_ListRoom : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service *service) {}
   public:
    WithStreamedUnaryMethod_ListRoom() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::hw::Request, ::hw::ChatRoom>(std::bind(&WithStreamedUnaryMethod_ListRoom<BaseClass>::StreamedListRoom, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ~WithStreamedUnaryMethod_ListRoom() override {
      BaseClassMustBeDerivedFromService(this);
    }
    ...
    virtual ::grpc::Status StreamedListRoom(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::hw::Request,::hw::ChatRoom>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_ListRoom<WithStreamedUnaryMethod_JoinRoom<WithStreamedUnaryMethod_LeaveRoom<WithStreamedUnaryMethod_Chat<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_ListRoom<WithStreamedUnaryMethod_JoinRoom<WithStreamedUnaryMethod_LeaveRoom<WithStreamedUnaryMethod_Chat<Service > > > > StreamedService;
};
