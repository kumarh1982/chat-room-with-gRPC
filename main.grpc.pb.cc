...
MainServer::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_ListRoom_(MainServer_method_names[0], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_JoinRoom_(MainServer_method_names[1], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_LeaveRoom_(MainServer_method_names[2], ::grpc::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Chat_(MainServer_method_names[3], ::grpc::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status MainServer::Stub::ListRoom(::grpc::ClientContext* context, const ::hw::Request& request, ::hw::ChatRoom* response) {
  return ::grpc::BlockingUnaryCall(channel_.get(), rpcmethod_ListRoom_, context, request, response);
}

::grpc::ClientAsyncResponseReader< ::hw::ChatRoom>* MainServer::Stub::AsyncListRoomRaw(::grpc::ClientContext* context, const ::hw::Request& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::ClientAsyncResponseReader< ::hw::ChatRoom>::Create(channel_.get(), cq, rpcmethod_ListRoom_, context, request);
}
...
::grpc::Status MainServer::Service::ListRoom(::grpc::ServerContext* context, const ::hw::Request* request, ::hw::ChatRoom* response) {
  (void) context;
  (void) request;
  (void) response;
